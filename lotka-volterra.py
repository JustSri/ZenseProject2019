...
name7.pack()
name8 = Label(Select_Screen,text='Please select the initial populations and the various constants you would like in your graph, press the button Use These Factors, then close this Window to be able to select the graph')
name8.pack()
